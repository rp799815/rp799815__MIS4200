...
namespace rp799815_MIS4200.Controllers
{
    public class CoursesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "courseID,name,description,classDate,studentId")] Course course)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "courseID,name,description,classDate,studentId")] Course course)
        {
            if (ModelState.IsValid)
            {
